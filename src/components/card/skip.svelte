...
<button
	...
	class={`hover:cursor-pointer group rounded-md hover:bg-[#e85682] bg-[#fd6693] absolute top-6 right-6 px-4 py-2 text-center flex flex-col items-center justify-center text-white font-bold `}
>
	Next
</button>
